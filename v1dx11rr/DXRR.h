...
public:	
    ...
    DXRR(HWND hWnd, int Ancho, int Alto)
	{
		...
		skydome = new SkyDome(32, 32, 100.0f, &d3dDevice, &d3dContext, L"dia.png");
		billboard = new BillboardRR(L"Assets/Billboards/fuego-anim.png",L"Assets/Billboards/fuego-anim-normal.png", d3dDevice, d3dContext, 5);

		camioneta = new ModeloRR(d3dDevice, d3dContext, "Assets/Camioneta/camioneta.obj", L"Assets/Camioneta/camioneta_color.png", L"Assets/Camioneta/camioneta_AO.png", 0, 5);
		brazo = new ModeloRR(d3dDevice, d3dContext, "Assets/Brazo/Brazo_Robotico.obj", L"Assets/Brazo/brazo_color.png", L"Assets/Brazo/brazo_AO.png", 10, 15);
		reloj = new ModeloRR(d3dDevice, d3dContext, "Assets/Reloj/Reloj.obj", L"Assets/Reloj/reloj_color.png", L"Assets/Reloj/reloj_AO.png", 0, 5);
		ruinas = new ModeloRR(d3dDevice, d3dContext, "Assets/Ruinas/Ruinas.obj", L"Assets/Ruinas/ruinas_color.png", L"Assets/Ruinas/ruinas_AO.png",0, 25);
		brujula = new ModeloRR(d3dDevice, d3dContext, "Assets/Brujula/Brujula.obj", L"Assets/Brujula/brujula_color.png", L"Assets/Brujula/brujula_AO.png", 0, 5);
		llanta = new ModeloRR(d3dDevice, d3dContext, "Assets/Llanta/Llanta.obj", L"Assets/Llanta/llanta_color.png", L"Assets/Llanta/llanta_AO.png", 0, 15);
	...
	void Render(void)
	{
		...
		camioneta->Draw(camara->vista, camara->proyeccion, terreno->Superficie(100, 50), camara->posCam, 10.0f, 0, 'A', 1);
		brazo->Draw(camara->vista, camara->proyeccion, terreno->Superficie(100, 50), camara->posCam, 10.0f, 0, 'A', 1);
		reloj->Draw(camara->vista, camara->proyeccion, terreno->Superficie(100, 50), camara->posCam, 10.0f, 0, 'A', 1);
		ruinas->Draw(camara->vista, camara->proyeccion, terreno->Superficie(100, 50), camara->posCam, 10.0f, 0, 'A', 1);
		brujula->Draw(camara->vista, camara->proyeccion, terreno->Superficie(100, 50), camara->posCam, 10.0f, 0, 'A', 1);
		llanta->Draw(camara->vista, camara->proyeccion, terreno->Superficie(100, 50), camara->posCam, 10.0f, 0, 'A', 1);
